...
class DEGANResSynthesizer(BaseSynthesizer):
    ...
    def fit(self, train_data, categorical_columns=tuple(), ordinal_columns=tuple()):
        ...
        discriminator = AEdisRes(data_dim, self.dis_dim, latent=self.latent).to(self.device)
        ...
        for i in range(self.epochs):
            for id_ in range(steps_per_epoch):
                ...
                recon_loss = self.alpha * ( F.mse_loss(x_hat_r, real_cat))
